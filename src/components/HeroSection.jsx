      ...
      <div className="relative min-h-screen md:pb-20 flex flex-col items-center w-full max-w-[1340px] mx-auto px-4 md:px-8 bg-[#1A3255]">
        ...
        <div className="w-full flex flex-col items-center text-center mt-20 md:mt-28">
          ...
          <p className="font-semibold lg:text-lg md:w-[700px] lg:w-[700px] text-white mt-6 md:mt-8 mx-auto px-2">
            We specialize in end-to-end eCommerce management, website and app development, product optimization, advertising strategy (ROI/ACOS improvement), and result-driven digital marketing services.
            Our goal is to help businesses scale across leading marketplaces such as Amazon, Walmart, eBay, Etsy, and Shopify, while also enhancing their online visibility through powerful website and Digital marketing  solutions.
            We focus on building a strong, recognizable, and profitable brand presence with innovative and growth-oriented digital strategies.
          </p>

...
const Navbar = () => {
      ...
      <div className="w-full max-w-[1340px] mx-auto flex justify-between items-center py-2 px-4">
        ...
        <ul className="hidden lg:flex items-center gap-12 font-semibold text-black relative">
          ...
          <Link to="/about" onClick={() => setShowServices(false)}>
            <li className="text-lg cursor-pointer hover:text-yellow-500 transition">
              About
            </li>
          </Link>
          <a
          ...
          {/* Services Dropdown */}
          <li
            className="text-lg  flex items-center gap-1 cursor-pointer hover:text-yellow-500 transition relative"
          ...
          <Link to="/contact" onClick={() => setShowServices(false)}>
           ...
           <Link to="/career" onClick={() => setShowServices(false)}>
            <li className="text-lg font-semibold flex items-center gap-1 cursor-pointer hover:text-yellow-500 transition">
              Career
            </li>
          </Link>
      ...
      >
        <ul className="flex flex-col p-4 gap-4 font-medium text-black">
          <Link to="/" onClick={() => setOpen(false)}>
            <li className="flex text-lg text-black items-center gap-2 hover:text-yellow-500">
              <HousePlus className="w-5 h-5" /> Home
            </li>
          </Link>
  ...
  <a
          ...
          >
            <li className="text-lg  flex items-center gap-1 cursor-pointer hover:text-yellow-500 transition">
              Drop Shipping
            </li>
          </a>
          ...
          <li
            ...
            className="flex text-lg items-center gap-1 cursor-pointer hover:text-yellow-500"
          >
            Services
          ...
          {showServices && (
            <ul className="ml-4 flex flex-col gap-2 text-gray-700">
              ...
              >
                <li className="hover:text-yellow-500">E-commerce</li>
              </Link>
              <Link
              ...
              >
                <li className="hover:text-yellow-500">Digital Marketing</li>
              </Link>
              <Link
              ...
              >
                <li className="hover:text-yellow-500">Product Photography</li>
              </Link>
              <Link
              ...
              >
                <li className="hover:text-yellow-500">App Development</li>
              </Link>
              <Link
                to="/services/bpo"
                onClick={() => {
              ...
              >
                <li className="hover:text-yellow-500">BPO Service</li>
              </Link>
            </ul>
          )}

          <Link to="/contact" onClick={() => setOpen(false)}>
            <li className="text-lg hover:text-yellow-500">Contact Us</li>
          </Link>

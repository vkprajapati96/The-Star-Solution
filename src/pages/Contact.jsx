      ...
      <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 flex flex-col justify-start gap-6 p-8 sm:p-10">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg sm:text-xl font-semibold text-black">The Star Solution
          ...
          <div className="flex items-center gap-3">
            ...
            info@thestarsolution.com <br /> hr@thestarsolution.com </span>
...
Have Questions Or Need Support? Reach Out To Us — We’re Here To Help.          </p>
        </div>
      </div>
